...
interface TOTPVerificationProps extends WithAuthHandling, WithStyles<typeof styles>, RouteComponentProps, WithSnackbarProps {
}
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    onChange={(e): void  => this.setState({totp_backup_code: e.currentTarget.value})}
                                />
                            </Grid>
                            <Grid item xs={12}>
                                <div className={classes.buttonBar}>
